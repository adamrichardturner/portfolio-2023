      ...
      <div className='space-y-4 p-6'>
        ...
        <div className='flex justify-start items-center'>
          ...
          {project.demoLink && (
            ...
            >
              <div className='bg-secondary hover:shadow-lg transition-shadow text-center ease-in-out w-24 px-4 shadow py-2 rounded-lg font-semibold text-sm text-white mr-2'>
                Demo
              </div>
            </a>
          )}
          ...
          {project.githubLink && (
            <a
              ...
              rel='noopener noreferrer'
            >
              <div className='bg-primary hover:shadow-lg transition-shadow text-center ease-in-out w-24 px-4 shadow py-2 rounded-lg font-semibold text-sm text-white'>
                GitHub
              </div>
            </a>
          )}
